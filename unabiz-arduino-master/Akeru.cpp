...
bool Akeru::getRegion(String *result)
{
	//  Get SIGFOX region.
	String data = "";
...
bool Akeru::setRegionETSI(String *result)
{
...
bool Akeru::setRegionFCC(String *result)
{
...
bool Akeru::sendTestMessage(int count, int period, int channel, String *result)
{
	//  Send test message.
	String data = "";
...
bool Akeru::sendCommand(String cmd, String *result)
{
	//  Send command.
	String data = "";
	if (sendATCommand(cmd, ATCOMMAND_TIMEOUT, &data))
